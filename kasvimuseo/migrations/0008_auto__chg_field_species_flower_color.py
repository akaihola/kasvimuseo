...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Species.flower_color'
        db.alter_column('kasvimuseo_species', 'flower_color', self.gf('django.db.models.fields.CharField')(max_length=80))


    def backwards(self, orm):
        
        # Changing field 'Species.flower_color'
        db.alter_column('kasvimuseo_species', 'flower_color', self.gf('django.db.models.fields.CharField')(max_length=40))
