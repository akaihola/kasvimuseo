...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Species.name_local'
        db.delete_column('kasvimuseo_species', 'name_local')

        # Deleting field 'Species.abbr_fi'
        db.delete_column('kasvimuseo_species', 'abbr_fi')

        # Deleting field 'Species.abbr_scientific'
        db.delete_column('kasvimuseo_species', 'abbr_scientific')

        # Deleting field 'Species.name_sv'
        db.delete_column('kasvimuseo_species', 'name_sv')


    def backwards(self, orm):
        
        # Adding field 'Species.name_local'
        db.add_column('kasvimuseo_species', 'name_local', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Species.abbr_fi'
        db.add_column('kasvimuseo_species', 'abbr_fi', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Species.abbr_scientific'
        db.add_column('kasvimuseo_species', 'abbr_scientific', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'Species.name_sv'
        db.add_column('kasvimuseo_species', 'name_sv', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)
