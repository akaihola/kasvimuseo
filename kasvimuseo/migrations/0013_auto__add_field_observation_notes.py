...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('kasvimuseo_observation', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Observation.notes'
        db.delete_column('kasvimuseo_observation', 'notes')
