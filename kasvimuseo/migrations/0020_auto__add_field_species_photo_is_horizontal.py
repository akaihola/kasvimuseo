...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.photo_is_horizontal'
        db.add_column(u'kasvimuseo_species', 'photo_is_horizontal',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.photo_is_horizontal'
        db.delete_column(u'kasvimuseo_species', 'photo_is_horizontal')
