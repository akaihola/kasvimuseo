...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Species.photo'
        db.add_column('kasvimuseo_species', 'photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Photo'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Species.photo'
        db.delete_column('kasvimuseo_species', 'photo_id')
