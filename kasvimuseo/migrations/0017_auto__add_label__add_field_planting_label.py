...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'kasvimuseo_planting', 'label',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kasvimuseo.Label'], null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'kasvimuseo.planting': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kasvimuseo.Label']", 'null': 'True'}),
