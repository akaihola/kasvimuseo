...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PlantingPhoto'
        db.create_table('kasvimuseo_plantingphoto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('planting', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kasvimuseo.Planting'])),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateField')()),
            ('photographer', self.gf('django.db.models.fields.CharField')(max_length=80)),
        ))
        db.send_create_signal('kasvimuseo', ['PlantingPhoto'])

        # Changing field 'Species.external_id'
        db.alter_column('kasvimuseo_species', 'external_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Location.external_id'
        db.alter_column('kasvimuseo_location', 'external_id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Adding field 'Observation.environment'
        db.add_column('kasvimuseo_observation', 'environment', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'Observation.nickname'
        db.alter_column('kasvimuseo_observation', 'nickname', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Deleting model 'PlantingPhoto'
        db.delete_table('kasvimuseo_plantingphoto')

        # Changing field 'Species.external_id'
        db.alter_column('kasvimuseo_species', 'external_id', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Location.external_id'
        db.alter_column('kasvimuseo_location', 'external_id', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Deleting field 'Observation.environment'
        db.delete_column('kasvimuseo_observation', 'environment')

        # Changing field 'Observation.nickname'
        db.alter_column('kasvimuseo_observation', 'nickname', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'kasvimuseo.species': {
            ...
            'abbr_fi': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'abbr_scientific': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'external_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
