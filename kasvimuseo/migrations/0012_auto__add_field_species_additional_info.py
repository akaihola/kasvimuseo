...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Species.additional_info'
        db.add_column('kasvimuseo_species', 'additional_info', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Species.additional_info'
        db.delete_column('kasvimuseo_species', 'additional_info')
