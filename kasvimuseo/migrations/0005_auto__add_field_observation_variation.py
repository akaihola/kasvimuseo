...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Observation.variation'
        db.add_column('kasvimuseo_observation', 'variation', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Observation.variation'
        db.delete_column('kasvimuseo_observation', 'variation')
