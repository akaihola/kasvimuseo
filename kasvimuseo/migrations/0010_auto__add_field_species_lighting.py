...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Species.lighting'
        db.add_column('kasvimuseo_species', 'lighting', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Species.lighting'
        db.delete_column('kasvimuseo_species', 'lighting')
