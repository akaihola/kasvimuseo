...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bed.public'
        db.add_column('kasvimuseo_bed', 'public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bed.public'
        db.delete_column('kasvimuseo_bed', 'public')
