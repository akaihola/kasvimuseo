...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Label'
        db.create_table(u'kasvimuseo_label', (
        ...
        db.send_create_signal(u'kasvimuseo', ['Label'])

        # Adding field 'Planting.label'
        db.add_column(u'kasvimuseo_planting', 'label',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kasvimuseo.Label'], null=True, on_delete=models.SET_NULL),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Label'
        db.delete_table(u'kasvimuseo_label')

        # Deleting field 'Planting.label'
        db.delete_column(u'kasvimuseo_planting', 'label_id')
    ...
    models = {
        ...
        u'kasvimuseo.planting': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['kasvimuseo.Label']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
