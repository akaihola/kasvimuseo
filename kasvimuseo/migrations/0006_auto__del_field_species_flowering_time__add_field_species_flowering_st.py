...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Species.flowering_time'
        db.delete_column('kasvimuseo_species', 'flowering_time')

        # Adding field 'Species.flowering_start'
        db.add_column('kasvimuseo_species', 'flowering_start', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Species.flowering_end'
        db.add_column('kasvimuseo_species', 'flowering_end', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Species.flowering_time'
        db.add_column('kasvimuseo_species', 'flowering_time', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Deleting field 'Species.flowering_start'
        db.delete_column('kasvimuseo_species', 'flowering_start')

        # Deleting field 'Species.flowering_end'
        db.delete_column('kasvimuseo_species', 'flowering_end')
