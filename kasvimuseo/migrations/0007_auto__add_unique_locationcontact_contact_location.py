...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'LocationContact', fields ['contact', 'location']
        db.create_unique('kasvimuseo_location_contacts', ['contact_id', 'location_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'LocationContact', fields ['contact', 'location']
        db.delete_unique('kasvimuseo_location_contacts', ['contact_id', 'location_id'])
