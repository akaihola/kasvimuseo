...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.cultivation_history'
        db.add_column(u'kasvimuseo_species', 'cultivation_history',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Species.cultivation_history'
        db.delete_column(u'kasvimuseo_species', 'cultivation_history')
